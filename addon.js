...
(ytdlp.checkInstallation()) ? console.log('yt-dlp detectado y funcional') : console.error('[WARN] yt-dlp no esta instalado o no es ejecutable. Algunos hosts de video no funcionarán')
